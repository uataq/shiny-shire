...
sidebar <- dashboardSidebar(
  sidebarMenu(
    ...
    menuItem('Data', icon = icon('area-chart'), tabName='data',
             ...
             menuSubItem('Interactive timeseries', href='http://air.utah.edu/s/view/gasview/', icon=icon('line-chart'), newtab=F),
             menuSubItem('TRAX light-rail', href='http://air.utah.edu/s/view/trax/', icon=icon('train'), newtab=F),
             menuSubItem('Nerdmobile mobile lab', href='http://air.utah.edu/s/view/nerdmobile/', icon=icon('flask'), newtab=F)),
    menuItem('Tools', icon = icon('th'), tabName='widgets',
             menuSubItem('EZMet Arduino GUI', href='http://air.utah.edu/s/utilities/ezmet/', icon=icon('cloud')),
    ...
    menuItem('Code', icon=icon('code'), tabName='code',
             menuSubItem('Data processing', href='https://github.com/benfasoli/lair-proc', icon=icon('retweet')),
             menuSubItem('UATAQ package', href='https://github.com/benfasoli/uataq', icon=icon('registered'))),
    br(),
