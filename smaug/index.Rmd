...
fluidRow(
  column(2, h4('Ben')),
  column(7, sliderInput('sben', NULL, 0, 14, 0, step = 1, ticks = F, width = '100%')),
  column(3, dateInput('dben', NULL, value = Sys.Date()))
)

fluidRow(
  column(2, h4('Daniel')),
  column(7, sliderInput('sdaniel', NULL, 0, 14, 0, step = 1, ticks = F, width = '100%')),
  column(3, dateInput('ddaniel', NULL, value = Sys.Date()))
)

fluidRow(
  column(2, h4('Derek')),
  column(7, sliderInput('sderek', NULL, 0, 14, 0, step = 1, ticks = F, width = '100%')),
  column(3, dateInput('dderek', NULL, value = Sys.Date()))
)

fluidRow(
  column(2, h4('Dien')),
  column(7, sliderInput('sdien', NULL, 0, 14, 0, step = 1, ticks = F, width = '100%')),
  column(3, dateInput('ddien', NULL, value = Sys.Date()))
)

fluidRow(
  column(2, h4('Henrique')),
  column(7, sliderInput('shenrique', NULL, 0, 14, 0, step = 1, ticks = F, width = '100%')),
  column(3, dateInput('dhenrique', NULL, value = Sys.Date()))
)

fluidRow(
  column(2, h4('John')),
  column(7, sliderInput('sjohn', NULL, 0, 14, 0, step = 1, ticks = F, width = '100%')),
